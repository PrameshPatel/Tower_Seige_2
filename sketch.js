...
function draw() {
  ...
  box6.display("indigo", "white");
  box7.display("indigo", "white");
  box8.display("indigo", "white");
  box9.display("indigo", "white");
  ...
  box15.display("saffron", "white");
  py1.display(rgb(229, 116, 117), "white")
  py2.display(rgb(229, 116, 117), "white")
  py3.display(rgb(229, 116, 117), "white")
  py4.display(rgb(110, 71, 102), "white")
  py5.display(rgb(110, 71, 102), "white")
  py6.display(rgb(251, 189, 76), "white")
